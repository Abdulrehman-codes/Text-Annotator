...
genai.configure(api_key="AIzaSyABtjI3uHrhtxhEWbHDWcITdb7LxPiRXKk")
...
# List of prompts
prompts = [
    "Annotate the sentiment of the following tweet: '{tweet}'. Choose one of the labels: Positive, Extremely positive, Negative, Extremely Negative. Provide an explanation for your annotation.",
    "Analyze the sentiment of this tweet: '{tweet}'. Select a sentiment label from the following options: Positive, Extremely positive, Negative, Extremely Negative. Give a reason for your choice.",
